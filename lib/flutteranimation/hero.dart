        ...
        child: GestureDetector(
            ...
            onTap: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Yash()));
              timeDilation = 4.0;
            }),
        onWillPop: () {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: WidgetWithCodeView(
        ...
        codeLinkPrefix:
            'https://github.com/yashvenrakumar/flutter_widgets/blob/master/lib/flutteranimation/hero.dart',
      ),
    );
  }
}
...
class MyAwesomeWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return SafeArea(child: HeroWidget());
  }
}

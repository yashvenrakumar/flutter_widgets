...
class _CodeviewState extends State<Codeview> {
  ...
  sourceFilePath: 'lib/flutteranimation/anilalign.dart',
  codeLinkPrefix: ' https://github.com/yashvenrakumar/flutter_widgets/blob/master/lib/flutteranimation/anilalign.dart',
      ),

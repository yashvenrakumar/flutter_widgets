...
class BasicIntrinsicWidth extends StatefulWidget {
 
  @override
  _BasicIntrinsicWidthState createState() => _BasicIntrinsicWidthState();
}

class _BasicIntrinsicWidthState extends State<BasicIntrinsicWidth> {
